            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#defaultModalPrimary">
                        Add New Career Level
                    </button>
                    <div class="modal fade" id="defaultModalPrimary" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Add New Career Level</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="{{ route('career_level.store') }}" method="POST"
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>{{ $post->count() }} @if ($post->count() == 0) No Category
                            @elseif($post->count() == 1)
                            Category @else levels @endif
                        </h4>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <form method="POST" action="{{route('career_level.delete', $posts->id)}}">@csrf @method('DELETE')
                                    ...
                                    <div class="modal fade" id="defaultModalEdit{{ $levels->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body m-3">
                                                    <form action="{{ route('career_level.update', $levels->id) }}"
