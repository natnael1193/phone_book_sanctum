                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Add New Study Field</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <form action="{{ route('study_field.store') }}" method="POST"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <form method="POST" action="{{route('study_field.delete', $posts->id)}}">@csrf @method('DELETE')
                                    ...
                                    <div class="modal fade" id="defaultModalEdit{{ $levels->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body m-3">
                                                    <form action="{{ route('study_field.update', $levels->id) }}"
