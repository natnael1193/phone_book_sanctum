...
<span aria-hidden="true">&times;</span>
                        ...
                        <div class="alert-message">
                            ...
                            <div class="btn-list">
                              <a href="{{ route('company.edit', $companies->id) }}" > <button class="btn btn-primary" type="button">Edit</button></a>
...
<span aria-hidden="true">&times;</span>
                        ...
                        <div class="alert-message">
                            ...
                            <div class="btn-list">
                              <a href="{{ route('company.edit', $posts->id) }}" > <button class="btn btn-primary" type="button">Edit</button></a>
                                <button class="btn btn-danger" type="button">Delete</button>
                            </div>
                            <br>
