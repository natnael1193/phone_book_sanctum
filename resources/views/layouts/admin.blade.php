    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar">
            <div class="sidebar-content js-simplebar">
                ...
                <a class="sidebar-link" href="@if (Auth::user()->role == 1) /admin @elseif(Auth::user()->role == 4) /encoder @elseif(Auth::user()->role
                    == 5) /blogger @else / @endif">
                    ...
                    <li class="sidebar-item {{ request()->is('activity_log*') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('activity_log.index') }}">
                            <i class="align-middle" data-feather="user-check"></i> <span
                                class="align-middle">Activity Logs</span>
                        </a>
                    </li>
                @endif
                    ...
                    <li class="sidebar-item {{ request()->is('company*') ? 'active' : '' }}">
                        <a href="#forms1" data-toggle="collapse" class="sidebar-link collapsed">
                            <i class="align-middle" data-feather="book"></i> <span
                                class="align-middle">Companies</span>
                        </a>
                        <ul id="forms1" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                            <li class="sidebar-item "><a class="sidebar-link"
                                    href="{{ route('company.index') }}">All Companies</a></li>
                            <li class="sidebar-item"><a class="sidebar-link"
                                    href="{{ route('company.create') }}">Add New Company</a></li>
                        </ul>
                    </li>
                    <li class="sidebar-item {{ request()->is('company_category*') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('company_category.index') }}">
                            <i class="align-middle" data-feather="package"></i> <span class="align-middle">Company
                                Categories</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ request()->is('company_requests') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('company_requests.index') }}">
                            <i class="align-middle" data-feather="bell"></i> <span class="align-middle">Company
                                Requests</span>
                        </a>
                    </li>
                    <li class="sidebar-item {{ request()->is('company_requests*') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('company_requests.create') }}">
                            <i class="align-middle" data-feather="bell"></i> <span class="align-middle">InComplete
                                Companies</span>
                        </a>
                    </li>

                    <li class="sidebar-item {{ request()->is('verified_company*') ? 'active' : '' }}">
                        <a class="sidebar-link" href="{{ route('verified_company') }}">
                            <i class="align-middle" data-feather="move"></i> <span class="align-middle">Verfied
                                Companies</span>
                        </a>
                    </li>
                @endif
                @if (Auth::user()->role == 1 || Auth::user()->role == 5)
                    ...
                    <li class="sidebar-item {{ request()->is('blog*') ? 'active' : '' }}">
                        ...
                        <ul id="forms2" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                            <li class="sidebar-item"><a class="sidebar-link" href="{{ route('blog.index') }}">All
                                    Blogs</a></li>
                            <li class="sidebar-item"><a class="sidebar-link"
                                    href="{{ route('blog.create') }}">Add New Blog</a></li>
                        </ul>
                    </li>
                @endif
                <li class="sidebar-item {{ request()->is('vacancy*') ? 'active' : '' }}">
                    ...
                    <ul id="vacancy" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                        <li class="sidebar-item"><a class="sidebar-link" href="{{ route('vacancy.index') }}">All
                                Vacancies</a></li>
                        <li class="sidebar-item"><a class="sidebar-link" href="{{ route('vacancy.create') }}">Add
                                New Vacancy</a></li>
                    </ul>
                </li>
                <li class="sidebar-item {{ request()->is('tender*') ? 'active' : '' }}">
                    ...
                    <ul id="tinder" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                        <li class="sidebar-item"><a class="sidebar-link" href="{{ route('tender.index') }}">All
                                Tenders</a></li>
                        <li class="sidebar-item"><a class="sidebar-link" href="{{ route('tender.create') }}">Add
                                New Tender</a></li>
                    </ul>
                </li>
                <li class="sidebar-header">
                ...
                <li class="sidebar-item {{ request()->is('category*') ? 'active' : '' }}"><a class="sidebar-link"
                    ...
                    <li class="sidebar-item {{ request()->is('tender_sub_category*') ? 'active' : '' }}"><a class="sidebar-link"
                                                                                                 href="{{ route('tender_sub_category.index') }}">Tender SubCategory</a></li>
