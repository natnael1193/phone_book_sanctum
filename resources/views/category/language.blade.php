                        ...
                        <tbody>
                            ...
                            @foreach ($language as $languages)
                                <tr>
                                    ...
                                    <td>{{ $languages->name_am }}</td>
                                    <td>
                                        <div class="row">

                                            <button class="btn btn-primary mr-2" data-toggle="modal"
                                                data-target="#defaultModalEdit{{ $languages->id }}">Edit
                                            </button>
                                        </div>
                                    </td>
                                </tr>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3">
                        <form method="POST" action="{{ route('language_list.store') }}">
                            @csrf
                            <div class="row">
        ...
        <div class="modal fade" id="defaultModalEdit{{ $categories->id }}" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body m-3">
                        <form action="{{ route('language_list.update', $categories->id) }}" method="POST"
                            ...
                            <div class="modal-body m-3">
                                ...
                                <div class="for-group">
                                    ...
                                    <input type="text" name="name_am" class="form-control"
                                        value="{{ $categories->name_am }}" placeholder="language name">
                                </div>
                                <br>
                            </div>
