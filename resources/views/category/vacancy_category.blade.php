                    ...
                    <div class="modal fade" id="defaultModalPrimary" tabindex="-1" role="dialog" aria-hidden="true">
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <form action="{{ route('vacancy_category.store') }}" method="POST"
                                      enctype="multipart/form-data">
                                    @csrf
                                    <div class="modal-body m-3">
                                        <div class="for-group">
                                            <label>Vacancy Category Image</label>
                                        ...
                                        <div class="for-group">
                                            ...
                                            <label>Vacancy Category Name</label>
                                ...
                                <div class="modal fade" id="defaultModalEdit{{$categories->id}}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body m-3">
                                                <form action="{{ route('vacancy_category.update', $categories->id)}}"
