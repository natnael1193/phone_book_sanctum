...
<div class="container">
  ...
  <div class="form-group row">
    ...
    <tbody>
      <tr>
        {{-- <td><input type="hidden" name="user_id[ ]" id="user_id" class="form-control" value={{ auth()->user('subscriber')->id }}></td>
        <td><input type="hidden" name="company_id[ ]" id="company_id" class="form-control" value="{{ $post->id }}"></td> --}}
