        ...
        <div class="container-fluid p-0">
            ...
            <div class="row">
                <div class="col-12 col-xl-12 col-lg-12 col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <form method="POST" action="{{ route('tender.update', $post->id) }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="my-select" class="form-control" name="company_id">
                                                ...
                                                @foreach ($company as $companies)
                                                    <option value="{{ $companies->id }}" required>
                                    ...
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" placeholder="Email"
                                                value="{{ $post->image }}" name="image" imageOnly>
                                        </div>
                                    </div>
                                    <div class="col-4">
                                        <div class="form-group">
                                            ...
                                            @if (App\TenderCategory::all()->count() > 0)
                                                @foreach (App\TenderCategory::all()->sortBy('name') as $categories)
                                                    <optgroup label="{{ $categories->name }}">
                                                        <option value="{{ $post->tender_sub_category_id }}">
                                                            {{ $data = App\TenderSubCategory::find($post->tender_sub_category_id)->name }}
                                                        </option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" placeholder="Bond"
                                                value="{{ $post->reference_date }}" name="reference_date">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Title"
                                                value="{{ $post->title_am }}" name="title_am">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="summary-ckeditor" placeholder="description"
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" id="summary-ckeditor1" placeholder="description"
                                                name="description_am">{{ $post->description_am }}</textarea>
                                        </div>
                                    </div>
                                </div>
